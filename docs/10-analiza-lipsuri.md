...
`src/components/layout/header-menu.tsx`, toate cele 39 de migrații,
...
| `pnpm test:e2e` | **632 de verificări trecute, 284 sărite** — cele sărite sunt cele 13 suite `*-supabase.spec.ts`, care cer un Supabase local ce nu pornește în acest mediu (imaginile Docker: 429 de la Docker Hub, 403 prin proxy) |
