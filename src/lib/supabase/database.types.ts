...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      document_requirements: {
        Row: {
          created_at: string
          for_company_types:
            | Database["public"]["Enums"]["company_type"][]
            | null
          for_vehicle_types:
            | Database["public"]["Enums"]["vehicle_type"][]
            | null
    ...
    Functions: {
      ...
      company_can_act: { Args: { p_company_id: string }; Returns: boolean }
      ...
      is_transport_party: { Args: { p_transport_id: string }; Returns: boolean }
      ...
      my_confirmed_email: { Args: never; Returns: string }
      my_invitations: {
        Args: never
        Returns: {
          company_id: string
      ...
      queue_expiry_reminders: { Args: never; Returns: number }
      reject_offer: {
        Args: { p_offer_id: string }
        Returns: {
          booking_cargo_listing_id: string | null
