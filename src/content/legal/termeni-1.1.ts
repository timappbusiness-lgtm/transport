...
/**
 * Termeni și condiții, versiunea 1.1.
 *
 ...
 *
 * What changed from 1.0, and nothing else did: section 11 sent consumers
 * to the European online dispute resolution platform, which closed on 20
 * July 2025 (Regulation (EU) 2024/3228). It now names the ANPC alternative
 * dispute resolution platform, the one the footer links to. Accepting
 * 1.1 is asked of everybody who accepted 1.0.
 *
 * Keep this file when 1.2 arrives.
 */
export const TERMENI_1_1: LegalDocument = {
  slug: 'termeni',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'Dacă ești consumator, te poți adresa ANPC, inclusiv pentru soluționarea alternativă a litigiilor, pe platforma reclamatiisal.anpc.ro. Asta nu îți ia dreptul de a te adresa instanței.',
