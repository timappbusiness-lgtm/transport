...
export const MAIL_TEMPLATES: readonly MailTemplate[] = [
  ...
  { id: 'offer_received', label: 'Ofertă nouă pe o cerere' },
  { id: 'offer_withdrawn', label: 'Ofertă retrasă' },
  { id: 'offer_accepted', label: 'Ofertă acceptată' },
  ...
  { id: 'contract_generated', label: 'Contract de transport generat' },
  { id: 'contract_accepted', label: 'Contract acceptat de cealaltă parte' },
  ...
  { id: 'listing_hidden', label: 'Cerere sau traseu scos de pe panou' },
  { id: 'listing_restored', label: 'Cerere sau traseu repus pe panou' },
  { id: 'listing_expiring_soon', label: 'Cererea iese curând de pe panou' },
  { id: 'series_paused', label: 'Serie de trasee oprită' },
...
export const MAIL_SAMPLE_PAYLOAD: Record<string, string> = {
  ...
  carrier_name: 'Transport Exemplu SRL',
  offer_id: '00000000-0000-4000-8000-000000000004',
  ...
  outcome: 'rezolvată',
  resolution: 'Exemplu: am sunat firma, au confirmat, iar cererea a fost corectată.',
  order_id: '00000000-0000-4000-8000-000000000005',
  contract_number: 'CT-2026-00000000',
  contract_version: '2',
